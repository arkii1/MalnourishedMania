    ...
    public class CameraShake : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else 
        {
            ...
            //Vector3 newPos = Vector3.Lerp(FindObjectOfType<CameraFollow>().camShakeOffset, Vector3.zero, Time.deltaTime);
            //FindObjectOfType<CameraFollow>().camShakeOffset = newPos;
